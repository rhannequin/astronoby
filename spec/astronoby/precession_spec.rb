  ...
  describe "::matrix_for" do
    it "returns the right matrix for 2025-08-01" do
      ...
      expect(matrix.round(10)).to eq(
        Matrix[
          [0.9999805493, -0.0057204387, -0.0024854608],
          [0.0057204388, 0.9999836381, -7.0774e-06],
          [0.0024854607, -7.1407e-06, 0.9999969112]
        ]
      )
      # Skyfield: [
    ...
    it "returns the right matrix for 2050-01-01" do
      ...
      expect(matrix.round(10)).to eq(
        Matrix[
          [0.9999256847, -0.0111816018, -0.0048576577],
          [0.0111816021, 0.9999374836, -2.70991e-05],
          [0.004857657, -2.72193e-05, 0.9999882011]
        ]
      )
      # Skyfield: [
