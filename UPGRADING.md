...
and not an epoch. Method `#to_utc` has been dropped in favor as is was ambiguous
regarding the timescale used. Therefore, constant `JULIAN_DAY_NUMBER_OFFSET` has
also been dropped.
